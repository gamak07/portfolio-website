...
export default function Navbar() {
  ...
  return (
    <header className="top-0 right-0 left-0 z-50 border-b border-gray-200 bg-white backdrop-blur-sm dark:bg-gray-900 dark:border-gray-700 ">
      <div className="mx-auto max-w-6xl px-6">
        <div className="flex h-16 items-center justify-between">
          <div className="text-xl font-bold">
            <Link href="/" className="cursor-pointer text-gray-900 dark:text-white">
              Ganiyu Mubarak
            </Link>
          </div>
